...
export default function GitProjects({ repos, user }: GitProjectsProps) {
  return (
    <Section classProp="" className={css.section}>
      <Container classProp="" className={css.container} spacing="verticalXXXLrg">
              ...
              return (
                <article key={index} className={css.project}>
                  <span className={css.header}>
                    ...
                    <p className={css.homepage}>{homepage || 'No homepage'}</p> {/* Default to "No homepage" if null */}
                  </span>
                  ...
                  <span className={css.topicsContainer}>
                    {topics.map((topic, topicIndex) => (
                      <span key={topicIndex} className={css.topics}>
